            ...
            <div class="p-6">
                ...
                <form method="GET" action="{{ route('logs.index') }}" class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-end space-x-2">
                        ...
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-gray-500 text-white rounded">
                            Filter
                        </button>
                        <a href="{{ route('logs.index') }}" class="inline-flex items-center px-4 py-2 bg-red-600 text-white rounded">
                            Reset
                        </a>
                    </div>
                </form>
